...
* taxi_code: Содержит SQL-скрипты для создания таблиц базы данных PostgreSQL,вставки начальных данных и выполнение некоторых select запросов с созданной БД
